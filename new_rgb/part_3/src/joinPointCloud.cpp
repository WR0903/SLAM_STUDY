...
int main( int argc, char** argv )
{
    ...
    //读取图像
    frame1.rgb = cv::imread( "/home/wr/SLAM_STUDY/new_rgb/part_3/data/rgb1.png" );
    frame1.depth = cv::imread( "/home/wr/SLAM_STUDY/new_rgb/part_3/data/depth1.png", -1);
    frame2.rgb = cv::imread( "/home/wr/SLAM_STUDY/new_rgb/part_3/data/rgb2.png" );
    frame2.depth = cv::imread( "/home/wr/SLAM_STUDY/new_rgb/part_3/data/depth2.png", -1 );
    ...
    *output += *cloud2;
    pcl::io::savePCDFile("/home/wr/SLAM_STUDY/new_rgb/part_3/data/result.pcd", *output);
